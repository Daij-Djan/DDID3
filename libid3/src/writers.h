...
class ID3_CPP_EXPORT ID3_OStreamWriter : public ID3_Writer
{
 ...
 public:
  ID3_OStreamWriter(ostream& writer) : _stream(writer), _beg((uint32)_stream.tellp()) { ; }
  ...
  virtual pos_type getCur() { return (uint32)_stream.tellp(); }
};
...
class ID3_CPP_EXPORT ID3_IOStreamWriter : public ID3_Writer
{
 ...
 public:
  ID3_IOStreamWriter(iostream& writer) : _stream(writer), _beg((uint32)_stream.tellp()) { ; }
...
class ID3_CPP_EXPORT ID3_MemoryWriter : public ID3_Writer
{
 ...
 public:
  ...
  virtual size_type writeChars(const char_type buf[], size_type len)
  {
    size_type remaining = (size_type)(_end - _cur);
